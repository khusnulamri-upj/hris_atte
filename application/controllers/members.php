...
class Members extends CI_Controller {
	...
	*/
	...
	function update_account()
	{
		...
		$this->load->view('members/account_update_view', $this->data);
	}
	...
	function change_password()
	{
		...
		$this->load->view('members/password_update_view', $this->data);
	}
	...
	/*function update_email($user_id = FALSE, $token = FALSE)
	{
		...
		{
			$this->user_model->send_new_email_activation();
		}
		...
		{
			$this->user_model->verify_updated_email($user_id, $token);
		}
	...
	/*function manage_address_book()
	{
		...
		{
			$this->load->model('user_model');
			$this->user_model->manage_address_book();
		}
	...
	/*function insert_address()
	{
		...
		{		
			$this->load->model('user_model');
			$this->user_model->insert_address();
		}
	...
	/*function update_address($address_id = FALSE)
	{
		...
		{			
			$this->load->model('user_model');
			$this->user_model->update_address($address_id);
		}
