...
*/
	...
	*/
	//$config['security']['login_session_expire'] = 60*60*3;
        $config['security']['login_session_expire'] = 60*60*8;
	...
	*/
	$config['security']['static_salt'] = 'KHu517uL20xiii';
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<p class="message dismissible info">';
	
	// Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '</p>';
	
	// Error Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<p class="message dismissible error">';
