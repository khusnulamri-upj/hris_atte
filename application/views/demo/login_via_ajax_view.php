	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				...
				<p>This login example is a simplified version of the <a href="<?php echo $base_url; ?>user/">standard login method</a>, that instead uses ajax to submit a users credentials.</p>
			</div>		
		</div>
	</div>
