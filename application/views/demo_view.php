		...
		<div class="content main_content_bg parallel clearfix">
			...
			<div class="w33 r_margin frame parallel_target">
				...
				<ul class="bullet">
					...
					<li>
						<a href="<?php echo $base_url; ?>user/login_via_ajax">Login via Ajax</a>
					</li>
					<li>
						<a href="<?php echo $base_url; ?>user/register_account">Register for an Account</a>
					</li>
					<li>
						<a href="<?php echo $base_url; ?>auth_lite/privilege_examples">Privilege Examples</a>
					</li>
					<li>
						<a href="<?php echo $base_url; ?>user/forgotten_password">Reset Forgotten Password</a>
					</li>
					<li>
						<a href="<?php echo $base_url; ?>user/resend_activation_token">Resend Account Activation Token</a>
					</li>
					<li>
						<a href="<?php echo $base_url; ?>user/lite_library">Lite Library Examples</a>
					</li>
				</ul>
