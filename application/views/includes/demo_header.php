	<div class="content_wrap nav_bg">
		<div id="sub_nav_wrap" class="content">
			...
			<?php if (! $this->flexi_auth->is_logged_in_via_password()) { ?>
				<li>
					<a href="<?php echo $base_url;?>user"><?php echo ($this->flexi_auth->is_logged_in()) ? 'Login via Password' : 'Login';?></a>
				</li>
				<li>
			...
			<?php if (! $this->flexi_auth->is_logged_in()) { ?>
				<li>
					<a href="<?php echo $base_url;?>user/register_account">Register</a>
				</li>
			<?php } else { ?>
				<li>
